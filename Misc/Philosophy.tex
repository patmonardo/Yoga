...
\section{Transcendental Philosophy}
...
\paragraph{The system of the transcendental ideas}
...
\paragraph{Three kinds of antinomy of pure reason}
...
That there are three kinds of antinomyis grounded 
...
we've already shown elsewhere their \textbf{unavoidability} 
if judgments of this kind do not look back to a supersensible substratum
of the given objects, as appearances, but also their \textbf{resolvability} 
...
correct only insofar as it \textbf{happens} that many people agree about it,
...
\textbf{or} one must assume that the judgment of taste is really a concealed 
...
\paragraph{Architectonic of pure reason}
...
and is called \textbf{metaphysics};
...
although we set it aside here as not \textbf{now} pertaining to our end.

It is of the utmost importance to \textbf{isolate} cognitions 
...
the \textbf{transcendental cognition of the world},
the latter that of the connection of nature in its entirety to a being beyond nature, i.e.,
the transcendental \textbf{cognition of God}.
...
fades to their comon property.
\begin{enumerate}
\item In the Critique of Pure Reason, his absolute (x) is the sensible world
\item In the Critique of Practical Reason, the I comes to light as
...
\section{System of Science}
\subsection{Reason}

\subsubsection{Being}

\paragraph{General division} 
