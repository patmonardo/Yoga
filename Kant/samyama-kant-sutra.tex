...
YS III.16
    ...
    empiricam). Concepts that are made arbitrarily are the mathematical ones.
    ...
    performed in the preparation of them.
    ...
    The former aims for thoroughness and thus removes everything foreign,a
    ...
    Syllogistic method is that according to which a science is expounded in a chain of inferences.
    ...
    Meditation must accompany all reading and learning, and for this it is requisite
...
if I am not conscious of it, obscure.
    ...
    In general logic cannot deal    at all with mere representations and their possibility either.
     This it leaves
    to metaphysics.
    ...
    takes place.
     ...
     We will indicate that in its place, too.
      But we will not
    investigate how representations arise.
