...
> yadvalāj jāyate yat tat phalaṃ puruṣakārajam /
>
...
tat                   → tat
phalam                → phalam
puruṣakārajam         → puruṣakāra-jam
apūrvaḥ               → apūrvaḥ
saṃskṛtasyaiva        → saṃskṛtasya eva
saṃskṛtaḥ             → saṃskṛtaḥ
adhipateḥ             → adhipateḥ
phalam                → phalam
```
...
|---|---|---|
| yat-balāt | ablative singular compound in correlative construction | through the force of whatever [cause] |
| jāyate | third-person singular present middle of √`jan` | arises / is born |
| yat ... tat | neuter singular relative-correlative pair | whatever ... that |
| phalam | nominative/accusative neuter singular | fruit / result |
| puruṣakāra-jam | nominative/accusative neuter singular compound | born from operative activity |
| apūrvaḥ | nominative masculine singular adjective | not previously arisen / new relative to the cause |
| saṃskṛtasya eva | genitive masculine/neuter singular plus restriction | of a conditioned dharma alone |
| saṃskṛtaḥ | nominative masculine singular | a conditioned dharma |
| adhipateḥ | genitive masculine singular | of the predominant [condition] |
| phalam | nominative/accusative neuter singular | result |

`Yat ... yat ... tat` correlates source-force, arisen determination, and its
classification as operative result. `Apūrva` marks relational novelty within
the conditioned sequence; it need not mean creation from absolute nothing.

## 4. Grammar

The first half is a relative-correlative definition:

```text
yat [phalam]
    yat-balāt jāyate
tat
    puruṣakāra-jam phalam

whatever result
    arises through the force of something
that
    is a result born of operative activity
```
...
already arisen. Dominance is thus a relation between conditioned occurrences,
not an intrinsic label carried by the result in isolation.
...
|---|---|---|
| bala | force / efficacy | causal power through which the result arises |
| puruṣakāra | operative activity | person-like causal functioning attributed figuratively to a dharma |
| puruṣakāraja-phala | result born of operative activity | result relative to its direct causal agent |
| kartṛ | agent / performer | factor directly exercising productive function |
| akartṛ | non-agent | factor that may condition the result without directly producing it |
