...
> niśritam adeśasthaṃ ceti yathāsthānam eṣāṃ kramaḥ syāt /
...
kārikā and the prose's `varttamānaviṣayatva`. The running
`dūrāśutaravṛttyā 'nyat` differs from the research verse's
`dūrāśutaravṛtty anyat`. Both forms are retained in their respective
positions; the repeated prose instrumental makes the explanatory sense
“by farther or quicker operation” clear. `Punaśctvāri` and
`upāriṣṭāt` are normalized, with appropriate sandhi in the reading text.

Three damaged expressions are not silently reconstructed. The mental-object
compound `vyadhvānadhraviṣayam`, the phrase `aprāptasyaiva jihvā
bhojyasya`, and `takyāḥ syāsya bahulyena` remain as transmitted. Their
provisional construals are marked in the translation and analysis. The
research report supplies an interpretation of each, but these are not
independent intact readings of the running witness.
...
> operation. Eye and ear have distant objects, so they are placed before
> the other two. Of eye and ear, the eye operates farther away: one may
> see a river from afar without hearing its sound. Therefore the eye is
...
contrast involving temporal and non-temporal objects. That interpretation
is bracketed in the translation. The primary claim is secure at the level
...
Eye and ear are paired as having distant objects, and the river example
...
not resolve those philological questions. Original research files and the
Part One reading artifact remain unchanged.
