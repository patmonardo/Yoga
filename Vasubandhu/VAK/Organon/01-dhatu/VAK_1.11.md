...
yo 'nubandhaḥ         → yaḥ anubandhaḥ
śubhāśubhaḥ           → śubha-aśubhaḥ
mahābhūtāny upādāya  → mahābhūtāni upādāya
sa hy avijñaptir      → saḥ hi avijñaptiḥ
```
...
| anubandhaḥ | nominative masculine singular | continuity, connection; glossed by the Bhāṣya as `pravāha`, stream |
| śubha-aśubhaḥ | nominative masculine singular | wholesome or unwholesome; agrees with `anubandhaḥ` |
| mahābhūtāni | accusative neuter plural | the great elements |
| upādāya | absolutive | having taken as basis; depending upon |
| saḥ | demonstrative pronoun, nominative masculine singular | that; resumes `yaḥ anubandhaḥ` |
| hi | indeclinable particle | indeed; here also signals the assignment of a technical name |
| avijñaptiḥ | nominative feminine singular | non-disclosure; non-disclosive form |
| ucyate | third-person singular present passive of `√vac` | is called |

The Bhāṣya gives four lexical controls:
...
śubha / aśubha  = kuśala / akuśala
                  wholesome / unwholesome
```

## 4. Grammar

The verse is governed by a relative-correlative construction:

```text
yaḥ anubandhaḥ ...
    whatever continuity ...

saḥ ... avijñaptiḥ ucyate
    that is called avijñapti
```

`Yaḥ` and `śubha-aśubhaḥ` agree with the masculine noun `anubandhaḥ`.
The correlative `saḥ` resumes that continuity, while the feminine
...
The particle `api` is crucial. According to the Bhāṣya, “even” prevents the
two exceptional cases from restricting the definition. Avijñapti continues
also when a person is conscious and undistracted.
...
The syntactic construe is therefore:

```text
[vikṣipta-acittakasya api]
[yaḥ śubha-aśubhaḥ anubandhaḥ]
[mahābhūtāni upādāya],
...
> Whatever wholesome or unwholesome continuity belongs even to one whose mind is directed elsewhere or who is without mind, while depending upon the great elements—that indeed is called avijñapti.
...
The concept is therefore broader than a residue left by outward action.
...
VAK 1.09 divided the rūpa aggregate into three components, and VAK 1.10
completed the analysis of the second:

```text
rūpa-skandha
    ├── five faculties
    ├── five sensory domains       ← analyzed in VAK 1.10
    └── avijñapti                  ← defined in VAK 1.11
```

The definition cannot be reduced to ethical continuity alone:
...
```text
otherwise-directed mind
    ∨ absence of occurrent mind
    ∨ present and undistracted mind
        → compatible with Continuance(avijñapti)
```

Its two stated sources are:

```text
vijñapti ──┐
           ├──→ wholesome or unwholesome avijñapti-rūpa
samādhi ───┘
```
...
upon the great elements, and continues as a stream. Nor should it be reduced
to a static karmic residue: it may arise from samādhi as well as manifest
bodily or verbal action.

The restrained Organon point is inward without being merely subjective:

```text
what is outwardly disclosed
    does not exhaust
