...
> vijñānaskandha ity ucyate / sa punaḥ ṣaḍ vijñānakāyāḥ /
> cakṣurvijñānaṃ yāvan manovijñānam iti / ya eṣa vijñānaskandha ukta
> āyatanavyavasthāyāṃ mana āyatanaṃ ca tat / dhātuvyavasthāyāṃ sa eva
> dhātavaḥ sapta ca matāḥ / katame sapta / ṣaḍ vijñānāny atho manaḥ /
> cakṣurvijñānadhātur yāvan manovijñānadhātur manodhātuś ca /
>
> evam atra pañca skandhā dvādaśāyatanāny aṣṭādaśa dhātavo nirddiṣṭā
> bhavanti / avijñaptivarjyo rūpaskandho daśāyatanāni daśa dhātavaḥ /
> vedanādayaḥ skandhās trayo 'vijñaptir asaṃskṛtāni ca dharmāyatanaṃ
> dharmadhātuś ca / vijñānaskandho mana āyatanaṃ ṣaḍ vijñānadhātavo
> manodhātuś ceti /

The natural unit runs from the definition at printed location 011.06
through the classificatory summary at 011.17–18. The next question asks
whether manodhātu is something additional to the six groups of vijñāna;
that question opens the commentary unit for 1.17.

Word division and punctuation are supplied for reading. The running source's
`saspta`, `bhavaṇti`, `dhatavaḥ`, and separated `vijñāna skandha` and
`vedanā dayaḥ` are normalized to `sapta`, `bhavanti`, `dhātavaḥ`,
`vijñānaskandha`, and `vedanādayaḥ`. The damaged joining
`manovijñānadhātumanodhātuś ca` is read as
`manovijñānadhātur manodhātuś ca`, following the research report and the
explicit enumeration. The quotation mark before `vijñapti` in the final
summary is read as an avagraha, giving `trayo 'vijñaptiḥ` in resolved
...
## 5. Apprehension with Respect to Each Object

`Prativijñapti` receives a syntactic expansion:
`viṣayaṃ viṣayaṃ prati vijñaptiḥ`. The repeated accusative
`viṣayaṃ viṣayam` is distributive, “each object,” and `prati` states the
relation with respect to that object. `Upalabdhiḥ`, apprehension, supplies
the direct explanatory gloss.

The prefix is therefore controlled by the prose's relational construction.
