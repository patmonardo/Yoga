...
ta eveṣṭā        → te eva iṣṭāḥ
daśāyatana-      → daśa-āyatana-
vedanānubhavaḥ   → vedanā anubhavaḥ
nimittodgrahaṇa- → nimitta-udgrahaṇa-
```
...
| āyatana | neuter noun in compound | sphere, gateway, relational field |
| dhātavaḥ | nominative masculine plural | domains |
| vedanā | nominative feminine singular | feeling, felt undergoing |
| anubhavaḥ | nominative masculine singular predicate noun | experience, undergoing |
| saṃjñā | nominative feminine singular | recognition through a distinguishing mark |
| nimitta | neuter noun in compound | mark, sign, distinguishing feature |
| udgrahaṇa | neuter action noun in compound | taking up, apprehending, grasping |
| ātmikā | nominative feminine singular | having as its nature; agrees with `saṃjñā` |
...
The first half contains an emphatic identity across classificatory
arrangements:
...
indriya-arthāḥ
    te eva
    iṣṭāḥ
    daśa āyatana-dhātavaḥ
```

`Te eva` means that no new sensible entities are added. The five faculties
and five objects already included within the rūpa aggregate are the very
same ten factors arranged as āyatanas and as dhātus.

The compound must be distributed according to the Bhāṣya:

```text
five faculties + five objects
    = ten āyatanas
    = ten dhātus
```

It does not mean one hybrid class of “ten āyatana-dhātus,” nor does it make
`āyatana` and `dhātu` synonyms. The same terms occupy positions in two
distinct systematic arrangements.

The second half consists of two nominal definitions:
...
The gender difference between feminine `vedanā` and masculine `anubhavaḥ`
...
> Those very faculties and objects are accepted as the ten spheres and the ten domains. Feeling is undergoing; recognition has the nature of grasping a mark.

### Bhāṣya-informed translation

> The same five sensory faculties and five sensory objects already included in the rūpa aggregate are arranged as ten āyatanas and as ten dhātus. Vedanā is pleasant, painful, or neutral felt experience; saṃjñā apprehends an encountered content through a distinguishing mark.

The first translation retains the Kārikā's compact nominal definitions. The
second guards against taking `anubhava` as consciousness in general or
`saṃjñā` as fully developed conceptual judgment.
...
|---|---|---|
| indriya | sensory faculty | refined material support of a corresponding cognition |
| artha | sensory object / content-correlate | object-side paired with a faculty; previously glossed as `viṣaya` |
| skandha | aggregate | organization as collection or immediate content-complex |
| āyatana | sphere / gateway | organization as a field of access and encounter |
| dhātu | domain | organization by determinate kind and lawful cognitive position |
| vedanā | felt undergoing | hedonic reception of contact |
| anubhava | experience / undergoing | pleasant, painful, or neutral experience here |
| saṃjñā | mark-recognition | stabilization of content through a distinguishing mark |
...
The verse establishes identity of content without identity of organization:
...
vak:AyatanaArrangement
    ...
    vak:distinctFrom vak:DhatuArrangement .

vak:DhatuArrangement
    a vak:DomainOrganization .
