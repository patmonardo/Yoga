...
output_file="$edition_dir/Organon-Kosa-Dhatu-Nirdesa.pdf"
...
pandoc "${sources[@]}" \
  ...
  --metadata title="The Organon Kośa: Dhātunirdeśa" \
  --metadata subtitle="The Systematic Principle of Dharma-Knowing" \
