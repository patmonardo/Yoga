...
output_file="$edition_dir/Organon-Kosa-Marga-Nirdesa.pdf"

sources=()
for number in $(seq -w 1 79); do
  sources+=("$organon_dir/06-marga/VAK_6.$number.md")
done
...
pandoc "${sources[@]}" \
  ...
  --metadata title="The Organon Kośa: Mārganirdeśa" \
  --metadata subtitle="The Systematic Analysis of the Path" \
  --metadata author="The Organon Project" \
  --metadata date="Provisional Complete-Chapter Edition · VAK 6.01–6.79" \
