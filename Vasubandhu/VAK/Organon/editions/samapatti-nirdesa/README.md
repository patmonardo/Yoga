# Samāpattinirdeśa Complete-Chapter Edition

This directory contains the provisional PDF reading edition generated from
all 43 current studies in `Organon/08-samapatti`, VAK 8.01–8.43.
...
The chapter sequence is complete. Individual studies and the resulting PDF
remain provisional until critical review.
...
Output: `Organon-Kosa-Samapatti-Nirdesa.pdf`
