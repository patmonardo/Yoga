# VAK_2.66 — Citta Class Matrix by Realm and Status

## 1. Sanskrit — Devanāgarī

```text
कुशलाकुशलं कामे निवृतानिवृतं मनः ।
रूपारूप्येष्वकुशलादन्यत्र अनास्रवं द्विधा ॥ VAkK_2.66 ॥
```
...
In the form and formless realms it is otherwise than unwholesome.
...
|---|---|---|
| kuśala | wholesome | Positive moral/status profile |
| akuśala | unwholesome | Negative moral/status profile |
...
```text
CittaStatusMatrix:
    kāma: kuśala | akuśala | nivṛta | anivṛta
    rūpa/ārūpya: kuśala | nivṛta | anivṛta
    anāsrava: twofold
```
...
Theme: citta class matrix by realm and status.
```
