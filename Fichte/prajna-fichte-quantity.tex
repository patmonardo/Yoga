...
1. By annihilating the formal concept, which is the condition
...
icate “is,” “persistence,” {des Bestehens} and therefore death. Instead, what is
...
negated qua concept. To be sure, insight can follow this very split, just as it is
...
well. Previously only the mere being of the concept was to have been negated;
...
knowing. On the other hand, in case someone is willing to grant
...
can altogether be only one and eternally self-same. Thereby our
...
facilitate the comprehension of what follows.) Result: since our initial sup-
...
only in a factical point of view. Here, too, this observation: that in our
...
follow. For the one as for the other, we will move forward tomorrow.
...
as happens in other cases. Instead, [we do so] through the highest thinking,
...
ing and error enter where appearance is taken for being itself. This seeming
