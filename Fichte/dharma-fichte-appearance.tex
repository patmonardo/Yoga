...
because otherwise the genesis would not be an absolute genesis.
...
since we now are pursuing the much higher task of
presenting the principle of this principle.
...
The subject matter that I wish to present
to your intuition appears in every transition from lassitude to energy,
and for our purposes, the example cited just above will serve best:
the one in which we had tacitly presupposed
absolute knowing to be a “from”;
when interrogated about the justification of this presupposition,
...
and [it was] this therefore because you abstracted completely from
all content,
