...
(we have initially expressed our problem empirically and
we must continue to speak this way until it has been solved),
a ground for this manifold must let itself
appear in the light itself as absolute oneness
...
In the last hour, this completed proof was itself investigated
in its central nerve and points of manifestness, and
what turned out to be its foundation was
...
knowing, are it as such.
This is an immediate demonstration of the essence of knowing,
conducted through the fact itself and its possibility.
At this point let yourself take in even more fully what was established last time, although only
in passing:
we did not make this presupposition because we wished to, or with
any sort of freedom;
and if only this free element, which is to be summoned
in response to some particular reflection, is to be called We, then we actu-
ally did not make it;
...
(but not absolutely in reason, by which even they
themselves are driven, although to be sure without their knowing it) and theT
relationship alone is evident, which however gives no final or fixed manifest-
ness, since the relationship itself depends on the reality of its terms.
They supplement the lack of this strength only by an arbitrary reliance on
...
every “We” that was presupposed as a premise in relation to
the secondary manifestness of the context.
Hence, we are transposed into a completely different region of knowing, not
simply as something purely self-grounding , but rather immediately,
and ipso facto from itself.
But as for what relates to the premise as a premise,
undoubtedly in this quality a consequence is posited through it, and
...
1. All along, and obviously in this proposition,
...
the knowing that you knew about, but rather in the knowing by which you knew it;
and it would go on this way for you even if you repeated the procedure a thousand times.
...
In our insight, it in no way follows from our insight into the essential
...
And we again lapsed into secondary and
merely apparent knowing with which there must, to be sure, eventually be an
end, an end we have sought so avidly from the beginning.
“It does not follow,”
...
an absolute genesis.
(What this latter means, and does not mean, since here as
well is yet another disjunction, will show itself it what follows.
) I say: accord-
...
ascended to our present insight, until we find it again on the descent.
This is
the first, and significant, point.
That the light in its changeless qualitative oneness is a “from” therefore
means: it is a qualitatively changeless permeation of the “from.
” In the pre-
...
The one, eternally qualitatively self-identical light, by
...
L
a — b
Hence, if light exists, then necessarily there is also a “from.”
Now if the
light is identical with the “from,” then, as surely as it itself exists, it spreads
itself in unchanged qualitative oneness across every “from,” and comprehends
every “from.
” And if one again posits within the first “from” another one that
...
higher task of presenting the principle of this principle.
This “from,” in pure,
...
is, in the already divided original light.
And thus the science of knowing jus-
...
creation.
Recall them.
In its pure qualitative oneness, “from” is genesis: that the
...
and seeing converge together completely and unconditionally.
—The words
...
indeed we knew ouselves in this presupposition and were the knowing.
I ask:
does not this new awareness, that was not yet there prior to our presupposing,
...
“from.
” What remains for you after this [act of ] abstraction? Evidently just a
...
a consciousness of absolute genesis.
Now—note this addition, the proof becomes
...
sented consciousness, which is thus required of you.
...
ing genesis, or as producing itself.
By means of this proof more is nearly proved
...
“from,” has already become immediately visible.
What we have to be concerned
with next here can be shown with a little preparation in two examples.
Because
you were instructed to reflect energetically and a new consciousness emerged
for you, this new consciousness is not to exist .
as something
new without the energy; this consciousness  and the energy should
open up together indivisibly.
Now you certainly posit genesis here partly in
...
this penetration were only explanatory means.
But, independent of all factic-
...
the light = “from,” that we have repeated and enriched today.
There is still another, and of this more tomorrow, equipped with today’s new discoveries!
...
I hope you do not need it, but rather
as a weapon of defense against the ignorant.
...
through his incompetence he is barred from the subject itself
and from any judgment about this world that is entirely concealed from him.
...
cannot in any way be made clear and true for very many people;
one can rather himself lay out the grounds for this impossibility,
...
terms.
1 You know that such a thing is possible in the science of knowing, and
why.
That is, [it is possible] because the subordinate terms will recur in their
...
absolute by abstracting from all relations. )
I connect this with what has gone before: the light has been presupposed
as an absolute “from.”
Then we immediately proved the legitimacy of this pre-
supposition by means of its bare possibility and facticity, because we ourselves
were light and knowing.
Based on this last key step in the proof, 3 the presup-
...
clearly explained yesterday).
Instead, [it is true and legitimate] in the We that
merges into the light, and is identical with it.
Moreover, it truly is just as it
factically occurs, but it occurs as a presupposition.
Hence, taken strictly (as we
...
ally does so.
In us, to the extent that we have merged, and disappear identi-
cally, into the light itself = [we] are the science of knowing.
Unnoticed, this
presupposition has made itself, and we will build on that.
But [the We] 5 on the
occasion of which it made itself, has in that sense not even made itself, instead
we, who are freely abstracting and reflecting, have made it.
Consequently, by
...
lower, ordinary, empirical knowing and higher, scientific, genetic knowing.
6
We said, “It is presupposed.
” 7 However, all presuppositions bring along a
hypothetical “should”; and let themselves be expressed through it.
In fact, we
...
____ ,” etc.
However, we have not only presupposed the absolute oneness of
the light hypothetically; [318–319] instead we have also realized it uncondi-
tionally.
To be sure, we have done so only in its qualitative character 8 —which
...
ness, as we discovered yesterday.
Hence, both are a result of the hypothetical-
ness, so that only pure, bare oneness, henceforth presented as inconceivable
and understood as categorical, remains left over.
I wished to undertake the
delineation of this very boundary in passing, and it is commended to you.
—
Now back.
Our reasoning has proceeded in the hypothetical form of a
...
Obviously we are once again reflecting
...
our activities in just this form.
Purely because we have left the realm of arbi-
...
2.
10 In its innermost essence, 11 a “should” is itself genesis and demands a
genesis.
This is easily understood; you ask, If such and such should be, then is
it or isn’t it? 12 The “should” tells you nothing about this.
What then does it say?
It sees 13 a principle; therefore, it explains categorically that being can be
admitted only on the condition of the principle.
Thus, only genetic being, or
being’s genesis, can be admitted.
Thus, it is the absolute postulation of gene-
...
ately, according to a law that we have yet to exhibit.
Or this as reinforcement:
I have said [the “should”] is the postulation of genesis.
...
accordingly the addition “of genesis” would not be worth while in any way.
So
...
Thus, there can be a disjunction within the absolute
genesis itself, through which it would be real and ideal.
This entire disjunction,
discovering the basis of which may well be our most important task, can now 16
follow from genesis, or the “should.
” Through resolving this disjunction, those
words, which we have used so far only provisionally and according to a dim
instinct in the hope of an eventual clarification, will themselves become clear.
17
...
ness.
We ourselves, or knowing and light as such, which are entirely the same
as us on the level of our present speculations, are this “from” immediately, in
that which we pursue and live.
So there is no further need for the “from” that
...
Therefore, we
let it all go as just a means of ascent, until it shows up again on our descent.
I said, “in that which we pursue and live”; and this very pursuing and living, as
...
absolutely genetic in relation to itself.
Because we ourselves were knowing, we
...
ously productive [one].
Thus, with this it is absolute genesis, which carries in
...
{Genesen} or two knowings from appearing impermanently.
We ourselves con-
duct one when we say, “If knowing (or we ourselves) should be ____”; and the
other one should be, if its principle is fulfilled.
I regard insight into this distinction of two aspects of knowing, a dis-
tinction that is still only factical, as simple.
Yet, it is so important that I can-
...
sis itself.
Nothing can depart from this; therefore, a distinction [322–323]
cannot be admitted within the subject matter itself, without contradicting
our first fundamental insight.
Hence, the disjunction that remains is not a
disjunction between two fundamentally distinct terms, instead it is a disjunc-
tion within one, which remains one throughout all disjunctions.
Something
of this sort has already presented itself to us earlier.
Stated popularly: it is not
a disjunction of two things, but rather just different aspects of one and the
same thing.
5.
Letting this disjunction stand provisionally, just as it has appeared to
...
within.
This choice can be shown to be completely necessary through another
circumstance as well.
For if we wish to work further, then we wish to pursue
and live knowing further as well.
Therefore, in fact and absolutely, we must
remain in life and cannot abstract from it, as is evident.
To do so would exactly
be not to live and search further, but instead to remain here, which would con-
tradict our intention not to stand still and instead to go further.
19
...
necessity, and contrary to its persistent preference for realism.
We will not
promise that the matter will come to rest with this principle, as it now stands
and as it will at once be explained more clearly.
We can promise more confi-
dently that we will never again use objectivity as a principle.
From this it will
follow that, if the idealistic principle too should prove inadequate, we will
need to find a third, higher principle that unites the two.
) 20
6.
Just as is demanded in this principle  of absolute idealism, the
inner self-genesis is presupposed as a living inward oneness—
what this is, on
...
be understood.
This latter [oneness is to be presupposed] as genesis (as was
made obvious yesterday in each transition from dull to energetic thinking), as
disappearing into the arising of an absolute “from” that in turn merges into
it, so that seeing and this arising are entirely inseparable—that is,
...
purely into one another.
The principle demands this: inner self-genesis is to
...
be united in knowing alone.
From the genetic principle, it would then follow158
The Science of Knowing
...
both, as is obvious.
This latter knowing is then the highest, and the two sub-
...
genesis.
Yet it does not not exist, rather it exists actually and in fact; thus [it
is] positive non-self-genesis; and yet it is immanent and is itself an I, because
this is its imperishable character, as absolute.
What else is negated besides
genesis?
Nothing, and to be sure this is negated positively;
but the positive negation of genesis is an enduring being.
Thus, knowing’s absolute, objective, and presupposed being
becomes evident in this higher knowing,
hence directly genetic, as it has previously appeared merely factically.
Once again, in order to review the terms of the proof:
as a result of positing a principle for
self-genesis within knowing itself,
[we derive] the explanation of genesis as not absolute;
consequently, [we infer] its positive negation within knowing;
and consequently [we also infer] the positing
within knowing of knowing’s absolute being.

If you have just grasped this rigorously,
then I can add something else in clarification.
This knowing, that only ought to exist, is of course a self-
...
insight and so apparently get outside of knowing.
Yet, in contrast to an absolute self-genesis,
which is itself annulled as absolute by the addition of a
...
in this case we were only concerned with
deriving the form of pure being and persistence.
In our case, this persistence is now, and
certainly always and eternally, genesis.
This existing knowing—which to that extent, is not genetic as regards its external
form—is enclosed in itself in unchangeable oneness, and so indeed [is] also
genesis, just as it seems to be above.
...
—[an awareness] of an original principle and
 an original principled thing in a one-sided,
 and certainly not reciprocal, order;
...
because what should follow, follows only on
the condition that it [that is, self-construction] is annulled
as absolute in itself, from itself, and through itself;
...
However, the highest, in which we remain, is the insight into both,
