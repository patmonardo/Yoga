...
that the principle of appearance is a principle of disjunction
within the aforementioned undivided oneness and
at the same time, obviously, within appearance.
...
but rather as the disjunction of two different disjunctive foundations.
...
inner production, containment, and support
of itself as identical with the free We,
the science of knowing.
This very inward hypotheticalness could be
what first shows itself and breaks through in
the subordinate terms’ hypothetical character.
...
Thus—making itself into an inward intuiting,
immediately by way of inner, living “being-a-principle,”
...
the procedure that arose yesterday in
the already established intuition,
...
very shocking in our age, which counts only on external workings,
