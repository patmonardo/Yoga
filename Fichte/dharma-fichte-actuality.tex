...
and have introduced insights that fundamentally
change the view of all being and knowing
...
but who has not yet seen into, and
achieved conviction about what is to be presented now,
...
one with the being previously seen into: certainty, pure and for
itself, as such.
...
unshakable continuance and resting in the same 11 unchangeable oneness;
...
I ask, if we repeat this procedure infinitely many times, as we seem able to do, could we
ever do it any differently?
...
Therefore, we view ourselves in the very same way we have described certainty, as persisting
unchangeably in the construction’s single same “what”;
we are what we say,
...
7. “Certainty is grounded in itself ” also means that it is
...
as a pure, rational expression of the true relationship of things:
the notion of intuition, or the concept,
...
a reconstruction related to the primordial projection through the law.
...
something conforming to law and as
...
1. In order to conduct the proof we have just completed, we
...
The light lives what it is in its very self,
...
Now, both cohere inwardly and essentially as image, positing a law, etc.,
and qualitative oneness can not come into it in any way.
...
It is essential oneness, the law of the image is likewise oneness,
and they posit one another entirely only through their inner essence,
...
By negating this concept, quantifiability was established
at the same time that we opened a more comfortable way to descend
into life and its multiplicity, as we know from the preceding.
Now, this qualitative oneness has been negated
through positing a oneness of image
...
As to this, I wished particularly that you had noticed for yourselves,
that we had to descend again to this quality only
...
the science of knowing must emerge
again as a particular knowing.
...
We must retrace this, our transformation into absolute knowing
...
—not of absolute knowing in itself, because this knows no origin;
but rather of absolute knowing’s actual existence and appearance in us
—
...
that in genuine, truly living knowledge right conduct
arises on its own, and that, even if he wishes to do so,
