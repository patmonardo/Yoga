...
It is the inner essence of pure seeing,
as such, which we have actually realized here in its essence,
...
therefore, what is negated is
simply absolute intuition as such.
...
brings absolute existence (of seeing, in fact) with itself.
It does so immediately [in the course of] performing this action,
and as the expression of doing so.
Said differently, absolute reason permeates itself as reason,
in exactly the way we have indicated, as absolute effect.
...
or its free ground.
Thus, we are only a mediate, factical appearance and insight,
...
as it had to come;
and all this has happened completely through abstraction.
...
however, it coincides with outward integrity in relation to others, and ends there.
