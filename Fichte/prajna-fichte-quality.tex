...
for the merely empirical and for the absolute impossibility of
...
and in the insight into this primordial act’s principle materially,
...
expressly surrenders and dies in relation
to the thing itself.
...
which can’t be shown on a blackboard nor be represented
in any way but can only be surrendered to nature.
...
its essence in itself and its being, which can only be a living being.
Thereby, however, what matters to us, since we add life to light, is
that we have nevertheless divided the two, have therefore,
as I said, actually killed the light’s inner liveliness
