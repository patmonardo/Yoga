...
Indeed, I have already adduced and shared with you everything which is
conducive for understanding these lectures and
which helps one enter their standpoint except for two things:
...
for someone who had really carried out the construction which we postulated,
this would only mean that he did not sustain
the construction in all clarity and power,
but instead that it faded because some distraction intervened.
That is, he did not place his total attention on the pzresent operation.
...
Hence, we see mediately into what
we previously had seen into immediately,
on the basis of its principle and the ground
of its being as it is;
...
already gone beyond this principle to a higher one and
that it has already begun to deduce this principle itself,
...
It is immediately clear that: the light is in us
...
I ask: apart from the arrangement of the terms, which is irrelevant here,
...
The listener must be able to elevate himself to
the required abstract level
...
but that splits itself only in the vital fulfillment of
thinking into an inessential disjunction,
which neither spoils the content in any way nor is grounded in it.
...
which we recognize as being and remaining true
 ...
 Is it not true in itself that the image entails something imaged and
vice versa?
 And, in this case, what exactly is true in itself?
  Just reduce what remains as a pure truth to the briefest expression.
Perhaps that a posits b and b, a?
Do we want to divide the true into two parts and then link these parts
...
unexplicated by any previous philosophy?
...
2. Creation of the science of knowing in its possible modifications.
