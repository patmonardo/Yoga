...
namely to introduce for the first time the materials for
resolving our second task,
...
for one to grasp the process [that, to be sure,
has its proper order] and terms,
and to give them what clarity
...
since the extent to which and the conditions under
...
Only on this condition can the science of knowing hope
to deduce the phenomenon in a genuine and grounded manner,
...
Therefore, from here on you should direct your attention to
the question whether and when a self-sustaining principle emerges.
...
roughly just the way we refuted the content’s highest idealism,
...
and likewise synthetic relation of
the two indicated relational terms must show itself.
...
as formal seeing itself, without any alter-
ation in the [seen] content ;
...
or the relation in its synthetic five-foldness, should come in.
As things stand, it can well be that
this external material genesis with and out of the content,
...
That just this insight, now characteristically distinguished
...
remaining after all abstraction that it exists entirely from itself
—whether you call it being or reason?
For example, is it arbitrarily posited as existing on its own?
How could it be?
...
that this same insight is possible in two different ways:
