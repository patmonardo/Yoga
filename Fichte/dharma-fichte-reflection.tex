...
Posit pure immanent being
as the absolute, substance, God, as indeed it really is,
and posit appearance,
...
of insight strives against it with all its might,
since freedom is always the last thing [this darkness] will surrender.
...
which afterwards will appear not in reason
and not in itself but as contingent
...
supposing therefore “If it should be ..., then ____must be.”
...
of the reasoning processes presented so far,
and [we] will then work on our remaining task from another angle.
...
say, “actually provide the content of this insight, which, according to your
...
mere seeing, is separated and existing for itself, should be brought into con-
nection with something else in seeing,
both as its condition and as conditioned by it,
initially through what you call insight.
Thus, in order to state the
...
our entire reasoning process: that being is constructed ideally,
