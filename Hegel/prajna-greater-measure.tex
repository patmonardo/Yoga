...
the exclusive elective affinity continues also into these opposite
neutralities,
...
Something, or a quality, based on such a ratio is driven
beyond itself into the measureless,
collapsing under the mere mutation of its magnitude.
Magnitude is that constitutional aspect
where an existence can be caught up in an apparently
