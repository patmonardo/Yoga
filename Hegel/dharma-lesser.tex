...
The essence shines within itself
or is pure reflection
and, as such, it is only a relation to itself,
not as immediate but instead
as reflected identity with itself.
    ...
    If identity is combined with the absolute as
    the subject of a sentence, the sentence reads as follows:
    'The absolute is what is identical with itself.'
    As true as this sentence is,
    it is ambiguous whether it is intended
    in its true significance.
    The expression of it at least is incomplete for this reason.
    For it is left undecided whether t
    he abstract identity of the understanding,
    in contrast to the other determinations of the essence,
    is meant or whether the identity is meant as in itself concrete;
    in the latter sense it is, as will become evident,
    first the ground and then at a higher level of truth the concept.
    Even the word 'absolute' has itself frequently
    no further meaning than that of 'abstract';
    ...
    taken as essential determinations,
    become predicates of a presupposed subject
    that is everything because
...
as one that sublates itself in itself, is appearance.
    ...
    in metals, crystals, and the like.)
    Just as there is no verification of
...
The relation of the appearance to itself is thus
completely determined, has the form in itself and
because [it is] in this identity,
...
as determinations of the form and, to be sure, unqualifiedly so,
as the abstractions of identity with itself and of sheer multiplicity or reality.
...
regard it, along with actuality and necessity, as modalities,
...
what was previously called 'the inner', with the only difference that it is now
...
a. the condition is (a) something presupposed as only
...
existence opposite one another, this process is the external necessity.
...
that its differences have the form of self-sufficient actuals and
this identity, as the absolute form, is at the same time
